...
## Adding (almost) full support to the easystats eco-system

To add support for models in the _easystats_ eco-system, especially for the packages [_parameters_](https://easystats.github.io/parameters/), or to support most / all features from _easystats_, following methods should be added to the _insight_ package:
...
The _simplest_ way is just adding a method for `parameters::model_parameters()`, however, than this model-class is not supported by _all_ functions we offer in the _easystats_ eco-system.
