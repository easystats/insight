...
test_that("format_p", {
  expect_equal(
    format_p(p, name = NULL),
    c("> .999", "0.900", "0.050", "0.010", "0.001", "< .001")
  )
  expect_equal(
    format_p(p, name = NULL, whitespace = FALSE),
    c(">.999", "0.900", "0.050", "0.010", "0.001", "<.001")
  )
  expect_equal(
    format_p(p, name = NULL, whitespace = FALSE, decimal_separator = ","),
    c(">,999", "0,900", "0,050", "0,010", "0,001", "<,001")
  )
})
...
test_that("format_message", {
  ...
  expect_equal(
    format_message(msg, line_length = 80),
  ...
  expect_equal(
    format_message(msg, line_length = 43.35),
  ...
  expect_equal(
    format_message(msg1, msg2, line_length = 40),
