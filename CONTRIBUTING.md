...
- insight uses [roxygen2](https://cran.r-project.org/package=roxygen2),
  with markdown syntax, for documentation.
- insight uses [testthat](https://cran.r-project.org/package=testthat).
  Adding tests to the PR makes it easier for me to merge your PR into
  the code base.
...
Conduct](https://easystats.github.io/insight/CODE_OF_CONDUCT.md). By
