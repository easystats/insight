...
`x`` ``<-`` ``iris``[``1``:``3``, `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``2``, ``5``)``]`\
\
`# the table as "readable" output`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``x``)`\
...
[`unclass`](https://rdrr.io/r/base/class.html)`(`[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``x``)``)`\
...
\
`# a simple caption`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``x``, caption ``=`` ``"Title"``)`\
`#> Title`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
`#> ------------------------------------`\
...
`out`` ``<-`` ``x`\
[`attr`](https://rdrr.io/r/base/attr.html)`(``out``, ``"table_caption"``)`` ``<-`` ``"Another title"`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``out``)`\
`#> Another title`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
`#> ------------------------------------`\
...
\
`# A red caption`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``x``, caption ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"# Title"``, ``"red"``)``)`\
`#> # Title`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
`#> ------------------------------------`\
...
`# same for attribute`\
`out`` ``<-`` ``x`\
[`attr`](https://rdrr.io/r/base/attr.html)`(``out``, ``"table_caption"``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"*A green title*"``, ``"green"``)`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``out``)`\
`#> *A green title*`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
...
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(`\
`  ``x``,`\
`  caption ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"# Title"``, ``"red"``)``,`\
`  footer ``=`` ``"Footer line"`\
`)`\
`#> # Title`\
`#> `\
...
`out`` ``<-`` ``x`\
[`attr`](https://rdrr.io/r/base/attr.html)`(``out``, ``"table_caption"``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"*A green title*"``, ``"green"``)`\
[`attr`](https://rdrr.io/r/base/attr.html)`(``out``, ``"table_footer"``)`` ``<-`` ``"A simple footer"`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``out``)`\
`#> *A green title*`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
...
`  ``x``,`\
`  caption ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"# Title"``, ``"red"``)``,`\
`  footer ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Footer line in blue"``, ``"blue"``)`\
`)`\
`#> # Title`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
...
`out`` ``<-`` ``x`\
[`attr`](https://rdrr.io/r/base/attr.html)`(``out``, ``"table_caption"``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"*A green title*"``, ``"green"``)`\
[`attr`](https://rdrr.io/r/base/attr.html)`(``out``, ``"table_footer"``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Footer line in blue"``, ``"blue"``)`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``out``)`\
`#> *A green title*`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
...
`  ``x``,`\
`  caption ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"# Title"``, ``"red"``)``,`\
`  subtitle ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"\n   A subtitle in yellow"``, ``"yellow"``)``,`\
`  footer ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Footer line in blue"``, ``"blue"``)`\
`)`\
`#> # Title `\
...
\
`x`` ``<-`` `[`list`](https://rdrr.io/r/base/list.html)`(`\
`  `[`data.frame`](https://rdrr.io/r/base/data.frame.html)`(``iris``[``1``:``3``, `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``2``, ``5``)``]``)``,`\
`  `[`data.frame`](https://rdrr.io/r/base/data.frame.html)`(``iris``[``51``:``53``, `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``3``, ``5``)``]``)``,`\
`  `[`data.frame`](https://rdrr.io/r/base/data.frame.html)`(``iris``[``111``:``113``, `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``4``, ``5``)``]``)`\
`)`\
\
...
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``x``, caption ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``"Table 1"``, ``"Table 2"``, ``"Table 3"``)``)`\
`#> Table 1`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
`#> ------------------------------------`\
...
`out`` ``<-`` ``x`\
`for`` ``(``i`` ``in`` `[`seq_along`](https://rdrr.io/r/base/seq.html)`(``out``)``)`` ``{`\
`  `[`attr`](https://rdrr.io/r/base/attr.html)`(``out``[[``i``]``]``, ``"table_caption"``)`` ``<-`` `[`paste`](https://rdrr.io/r/base/paste.html)`(``"Table"``, ``i``)`\
`}`\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(``out``)`\
`#> Table 1`\
`#> `\
...
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(`\
`  ``x``,`\
`  caption ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``"Table 1"``, ``"Table 2"``, ``"Table 3"``)``,`\
`  footer ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``"Footer 1\n\n"``, ``"Footer 2\n\n"``, ``"Footer 3\n\n"``)`\
`)`\
`#> Table 1`\
`#> `\
`#> Sepal.Length | Sepal.Width | Species`\
...
`    `[`c`](https://rdrr.io/r/base/c.html)`(``"Red Table 1"``, ``"red"``)``,`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(``"Blue Table 2"``, ``"blue"``)``,`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(``"Green Table 3"``, ``"green"``)`\
`  ``)``,`\
`  footer ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`\
`    `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Footer line 1\n"``, ``"green"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"Second line\n\n"``, ``"red"``)``)``,`\
`    `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Footer line A\n"``, ``"blue"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"Second line\n\n"``, ``"green"``)``)``,`\
`    `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Footer line I\n"``, ``"yellow"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"Second line\n\n"``, ``"blue"``)``)`\
`  ``)`\
`)`\
`#> Red Table 1`\
`#> `\
...
`out`` ``<-`` ``datawizard``::`[`data_codebook`](https://easystats.github.io/datawizard/reference/data_codebook.html)`(``efc``[``, ``1``:``3``]``)`\
`out``$``.row_id`` ``<-`` ``NULL`\
\
[`export_table`](https://easystats.github.io/insight/reference/export_table.md)`(`\
`  ``out``,`\
