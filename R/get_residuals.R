...
#'
#' @return The residuals, or `NULL` if this information could not be accessed.
#'
...
#' `glm` etc. To access different types, pass down the `type` argument
#' (see 'Examples').
#' \cr \cr
#' This function is a robust alternative to `residuals()`, as it works
